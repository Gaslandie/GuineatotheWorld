...
export default function ServicesSection({
  ...
  return (
    ...
    >
      <div className="svc-grid mx-auto grid max-w-[1400px] grid-cols-[minmax(280px,420px)_1fr] gap-20 px-10 py-[130px]">
        ...
        <div className="flex flex-col border-t border-[rgba(216,168,24,0.4)]">
          {dict.services.items.map((s, i) => (
            <div
              key={s.title}
              className="grid cursor-default grid-cols-[70px_1fr_auto] items-center gap-7 border-b border-[rgba(216,168,24,0.4)] px-5 py-[34px] transition-[background,padding] duration-300 hover:bg-white hover:px-7"
            >
              ...
              <div className="flex h-[52px] w-[52px] shrink-0 items-center justify-center rounded-full border border-[rgba(24,72,48,0.3)] text-vert">
